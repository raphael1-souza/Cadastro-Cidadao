                            ...
                            <div class="row u-justify-center">
                                <div class="col-md-7">
                                    <div class="u-mt-large u-text-center">
                                        <h4 class="u-mb-xsmall" style="padding-bottom:20px;padding-top:-10px;">Cadastro UF</h4>
                                    </div>
                                </div>
                            </div>
                            <form action="{{route('cadastro.uf')}}" method="POST" >
                            {{csrf_field()}}
                            <div class="row">

                            <div class="col-md-12">
                                <div class="c-field">
                                    <label class="c-field__label" for="input13">Código da UF: </label>
                                    <input class="c-input" type="text" name="codigo_uf" id="input13" required placeholder="">
                                ...
                                <div class="row">
                                    <div class="c-field col-md-12 u-mb-medium">
                                        ...
                                        <input class="c-input" type="text" name="descricao_uf" id="input13" required placeholder="">
                                        <small class="c-field__message">
                                            <i class="fa fa-info-circle"></i>Este campo é  obrigatório
                                        </small>
                                    </div>
